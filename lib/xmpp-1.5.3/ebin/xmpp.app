{application,xmpp,
             [{description,"Erlang/Elixir XMPP parsing and serialization library"},
              {vsn,"1.5.3"},
              {modules,['XmppAddr',captcha_form,flex_offline,http_upload,jid,
                        mam_query,muc_register,muc_request,muc_roomconfig,
                        muc_roominfo,p1_mucsub,pubsub_get_pending,
                        pubsub_meta_data,pubsub_node_config,
                        pubsub_publish_options,pubsub_subscribe_authorization,
                        ...
                        xep0215,xep0220,xep0221,xep0231,xep0234,xep0249,
                        xep0260,xep0261,xep0264,xep0279,xep0280,xep0297,
                        xep0300,xep0313,xep0319,xep0328,xep0333,xep0334,
                        xep0352,xep0355,xep0356,xep0357,xep0359,xep0363,
                        xep0369,xep0377,xep0405,xep0417,xep0430,xmpp,
                        xmpp_codec,xmpp_codec_external,xmpp_config,xmpp_lang,
                        xmpp_sasl,xmpp_sasl_anonymous,xmpp_sasl_digest,
                        xmpp_sasl_oauth,xmpp_sasl_plain,xmpp_sasl_scram,
                        xmpp_socket,xmpp_stream,xmpp_stream_in,
                        xmpp_stream_out,xmpp_stream_pkix,xmpp_sup,xmpp_tr,
                        xmpp_uri,xmpp_util]},
              {registered,[]},
